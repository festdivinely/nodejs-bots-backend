...
export async function sendVerificationEmail(receiverEmail, verificationLink) {
    /**
     * Send a verification email to the specified receiver.
    ...
    try {
        ...
        // Email content
        const subject = 'Verify Your Email - Divinely Bot';
        const plainBody = `
                    ...
                    <tr>
                        ...
                        <table width="600" border="0" cellspacing="0" cellpadding="0" 
                            ...
                            <td style="padding:30px; color:#333333; font-size:16px; line-height:1.6;">
                                ...
                                <p>
                                This link will expire in <b>30 minutes</b> for your security.  
